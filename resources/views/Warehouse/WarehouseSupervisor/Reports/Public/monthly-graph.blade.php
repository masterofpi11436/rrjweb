...
@section('content')
    ...
    <form method="GET" action="{{ route('public.reports.monthly-graph') }}" class="mb-6 flex gap-4 items-end">
        <div>
        ...
        <div class="ml-auto">
            <a href="{{ route('public.reports.monthly') }}"
        ...
        options: {
            ...
            onClick: function(event, elements) {
                if (elements.length > 0) {
                    ...
                    const url = `{{ url('warehouse/reports/monthly-graph') }}/${encodedItemName}?year=${year}&month=${month}`;
