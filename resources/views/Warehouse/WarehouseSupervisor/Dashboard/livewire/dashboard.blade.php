<div>
    <div class="grid grid-cols-3 gap-6">
        <a href="{{ route('warehouse.warehouse-supervisor.create-order.dashboard') }}">
            <div class="p-5 bg-green-700 text-white rounded shadow hover:bg-green-800">
        ...
        <a href="{{ route('warehouse.warehouse-supervisor.pending.dashboard') }}">
            <div class="p-5 bg-yellow-600 text-gray-900 rounded shadow hover:bg-yellow-700">
                <h3 class="text-lg font-semibold">Pending Orders</h3>
                <p class="text-gray-100 font-bold">{{ $pendingOrdersCount }}</p>
            </div>
        </a>
        ...
        <a href="{{ route('warehouse.warehouse-supervisor.pending-exchange.dashboard') }}">
            <div class="p-5 bg-yellow-600 text-gray-900 rounded shadow hover:bg-yellow-700">
                ...
                <p class="text-gray-100 font-bold">{{ $pendingExchangeOrdersCount }}</p>
            </div>
        </a>
    ...
    <div class="mt-10">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-gray-800 text-white border border-gray-700 rounded shadow">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-700">
                        ...
                        <td class="px-4 py-2 text-red-400 font-bold">{{ $item->quantity }}</td>
                        <td class="px-4 py-2">{{ $item->low_stock_threshold }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="3" class="px-4 py-2 text-center text-gray-400">No low stock items</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
