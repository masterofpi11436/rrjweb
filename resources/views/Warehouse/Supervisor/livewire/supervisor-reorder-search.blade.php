<div class="max-w-6xl mx-auto p-6 bg-gray-900 shadow-md rounded-lg text-gray-100">
    ...
    <script>
        function updateLivewireBeforeCheckout() {
            document.querySelectorAll('input[name^="cart_reorder"]').forEach(input => input.blur());
            setTimeout(() => {
                window.location.href = "{{ route('warehouse.supervisor.reorder-checkout') }}";
            }, 300);
        }
    </script>
