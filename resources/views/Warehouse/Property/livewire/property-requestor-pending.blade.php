                    ...
                    @foreach ($orders as $order)
                        <li class="p-3 border-b border-gray-700 last:border-b-0">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">
                                        Status: <span class="font-semibold text-yellow-400">
                            ...
                            @if($expandedOrderId === $order['id'])
                                <div class="mt-3 p-4 bg-gray-700 border border-gray-600 rounded-md shadow-md">
                                    ...
                                    <div class="flex justify-end space-x-2 mt-4">
                                        <a href="{{ route('warehouse.property.edit-requestor-order', ['id' => $order['id']]) }}"
                                            class="px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-lg shadow-md hover:bg-yellow-700">
                                            Edit Order
                                        </a>

                                        <a href="{{ route('warehouse.property.approve', $order['id']) }}"
