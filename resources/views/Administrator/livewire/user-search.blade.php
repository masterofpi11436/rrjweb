            ...
            <tr>
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('admin')"
                        title="Administreator for ALL Applications. Can log into all applications and perform CRUD operations">
                        Admin
                        @if ($sortColumn === 'admin')
                            @if ($sortDirection === 'asc')
                                ▲
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('vfm')"
                        title="Admin for the Vehicle Fleet Maintenance Forms.">
                        VFM
                        @if ($sortColumn === 'vfm')
                            @if ($sortDirection === 'asc')
                                ▲
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('vfm_tech')"
                        title="Technician can only create Vehicle Fleet Maintenance Forms">
                        VFM Tech
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('warehouse_role')"
                        title="Different levels of access for the Warehouse Store">
                        Warehouse
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('jurisdiction')"
                        title="Can remove/upload Time Logs for the jurisdiction logger">
                        Jurisdiction
                ...
                <th>
                    <a href="#" wire:click.prevent="sortBy('camera')"
                        title="Can remove/upload Time Logs for the camera logger">
                        Camera
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div>
                            <!-- Delete link -->
                            <a href="#"
                                onclick="event.preventDefault(); confirmDelete({{ $user->id }});">Delete</a>
                            <form id="delete-form-{{ $user->id }}"
                                action="{{ route('admin.destroy', $user->id) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            ...
                            <div id="custom-confirmation-modal-{{ $user->id }}" class="confirmation-modal"
                                ...
                                <div class="modal-content">
                                    ...
                                    <button class="btn-confirm" onclick="deleteRecord({{ $user->id }});">Yes,
                                        Delete</button>
                                    <button class="btn-cancel"
                                        onclick="hideModal({{ $user->id }});">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </td>
