    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="description" wire:model="description" rows="4"
                placeholder="Enter an optional evaluation description"
        ...
        <section class="overflow-hidden rounded-xl border border-gray-700 bg-gray-900">
            ...
            <div class="space-y-5 p-5">
                ...
                @foreach ($items as $index => $item)
                    <div wire:key="evaluation-item-{{ $item['id'] ?? 'new-' . $index }}"
                        ...
                        <div
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <button type="button" wire:click="removeItem({{ $index }})"
                                    wire:confirm="Are you sure you want to remove this evaluation item?"
                        ...
                        <div class="space-y-4 p-4">
                            ...
                            <div>
                                ...
                                <textarea id="item-{{ $index }}" wire:model="items.{{ $index }}.item" rows="3"
                                    placeholder="Enter the evaluation item"
