...
$reportsClass = ReportsController::class;
$historyClass = HistoryController::class;
...
Route::prefix('warehouse')->group(function () use ($warehouseLoginClass, $warehouseSupervisorClass, $supervisorClass, $requestorClass, $propertyClass, $itemClass, $categoryClass, $sectionClass, $userClass, $inventoryClass, $reportsClass, $historyClass, $createOrderClass, $createExchangeClass, $pendingOrderClass, $pendingExchangeOrderClass){
        ...
        Route::prefix('warehouse-supervisor')->middleware(['warehouseSupervisor', 'cache'])->group(function () use ($warehouseSupervisorClass, $itemClass, $categoryClass, $sectionClass, $userClass, $inventoryClass, $reportsClass, $historyClass, $createOrderClass, $createExchangeClass, $pendingOrderClass, $pendingExchangeOrderClass) {
            ...
            Route::prefix('reports')->group(function () use ($reportsClass) {
                ...
                Route::get('/fiscal-year-graph/item', [$reportsClass, 'fiscalYearReportItemGraph'])->name('warehouse.warehouse-supervisor.reports.fiscal-year-graph-item');
...
Route::prefix('training')->group(function () use ($traingingLoginClass, $trainingAdminClass, $trainingUserClass, $trainingAssignmentsClass, $trainingBookClass, $trainingModuleClass){
    ...
    // Admin Routes
    Route::prefix('admin')->middleware(['trainingAdmin', 'cache'])->group(function () use ($trainingAdminClass, $trainingUserClass, $trainingAssignmentsClass, $trainingBookClass, $trainingModuleClass) {
        Route::get('/dashboard', [$trainingAdminClass, 'dashboard'])->name('training.admin.dashboard');

        // User Management
        Route::prefix('user')->group(function () use ($trainingUserClass) {
        ...
        // Manage Training Statuses and Assign Books
        Route::prefix('assignments')->group(function () use ($trainingAssignmentsClass) {
            Route::get('/dashboard', [$trainingAssignmentsClass, 'dashboard'])->name('training.admin.assignments.dashboard');
            Route::get('/create', [$trainingAssignmentsClass, 'create'])->name('training.admin.assignments.create');
            Route::get('/edit/{id}', [$trainingAssignmentsClass, 'edit'])->name('training.admin.assignments.edit');
            Route::delete('/{id}', [$trainingAssignmentsClass, 'destroy'])->name('training.admin.assignments.destroy');
        });
