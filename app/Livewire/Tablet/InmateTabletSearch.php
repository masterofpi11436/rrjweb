...
class InmateTabletSearch extends Component
{
    ...
    public function render()
    {
        ...
        return view('Tablet.livewire.inmate-tablet-search', [
            'suggestions' => InmateTablet::where('inmate_number', 'like', '%' . $this->search . '%')
