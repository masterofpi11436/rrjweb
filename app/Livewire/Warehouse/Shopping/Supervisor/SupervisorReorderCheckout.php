...
class SupervisorReorderCheckout extends Component
{
    ...
    public function mount()
    {
        ...
        $this->cart = session()->get('cart_reorder', []);
    ...
    public function updateQuantity($itemId, $quantity)
    {
        ...
        $cart = session()->get('cart_reorder', []);
        if (isset($cart[$itemId])) {
            $cart[$itemId]['quantity'] = $quantity;
            session()->put('cart_reorder', $cart);
            $this->cart = $cart;
        }
    }
    ...
    {
        session()->forget('cart_reorder');
        $this->cart = [];
    }

    public function render()
    {
        return view('Warehouse.Supervisor.livewire.supervisor-reorder-checkout');
    }
