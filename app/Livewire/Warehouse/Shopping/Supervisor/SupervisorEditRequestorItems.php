...
class SupervisorEditRequestorItems extends Component
{
    use WithPagination;
    ...
    public function updateOrder()
    {
        ...
        redirect()->route('warehouse.supervisor.requestor-pending')->with('success', 'Order updated successfully!');
    }
    ...
    public function render()
    {
        ...
        return view('Warehouse.Supervisor.livewire.supervisor-edit-requestor-items', [
            'items'      => $items,
