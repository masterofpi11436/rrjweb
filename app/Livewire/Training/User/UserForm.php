...
class UserForm extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'training_role' => ['required', new Enum(TrainingUser::class)],
        ];
    }
    ...
    public function submitForm()
    {
        ...
        $user->training_role = TrainingUser::from($this->training_role);
        ...
        return redirect()->route('training.admin.user.dashboard');
    }
    ...
    {
        return view('Training.Admin.User.livewire.user-form');
    }
}
